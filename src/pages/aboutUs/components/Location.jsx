...
const Location = () => {
  return (
    <div className="h-[50vh] w-full relative mt-16">
      ...
      ></iframe>
      <div className="bg-white/70 backdrop-blur-[2px] hover:bg-white transition-all duration-500 shadow-lg rounded-md absolute top-1/2 -translate-y-1/2 right-[5%] w-1/4 !z-50 p-8 xl:p-12 space-y-8 ">
        <GradientText
