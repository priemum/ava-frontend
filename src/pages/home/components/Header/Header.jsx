...
const Header = () => {
  ...
  return (
    <div className="w-screen max-w-[1920px] h-[98vh] scroll-smooth">
      <div
        style={{
          backgroundImage: `url(${dubai})`,
        }}
        className="overflow-hidden bg-no-repeat bg-center bg-cover h-[98vh] flex justify-center items-center bg-fixed -z-20 absolute top-0 left-0 w-screen max-w-[1920px]"
      >
        <div
