...
import { useAddOpenHouseMutation } from "../../redux/openHouse/openHouseSlice";
...
const OpenHousePage = () => {
	...
	const [addOpenHouse, { isLoading, isSuccess, isError }] =
		useAddOpenHouseMutation();
	const form = useRef();
	...
	return (
		<div
			className='h-full min-h-screen w-full bg-center bg-cover bg-no-repeat flex flex-col justify-start items-center py-24 max-lg:space-y-7 lg:space-y-4 '
			style={{
