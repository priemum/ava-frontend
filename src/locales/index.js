	...
	resources: {
		ar: {
			translation: {
				...
				AreaSpecialty: "تخصص المنطقة",
				YearsOfExperience: "سنوات من الخبرة في مجال العقارات",
				EnglishLvl: "مستوى الانكليزية",
				ArabicLvl: "مستوى العربية",
				LinkedInURL: "رابط اللينكد إن",
				MessageToTeam: "رسالة الى فريق التوظيف",
				OtherLanguages: "لغات اخرى ",
				OpenHouseTitle: "احجز موعدك في منزلنا المفتوح",
				PreferredTime: "الوفت المرغوب",
				yourAgent: "العميل",
		...
		en: {
			translation: {
				...
				formAttendees: "Number of Attendees",
				...
				OpenHouseTitle: "BOOK YOUR APPOINTMENT IN OUR OPEN HOUSE",
